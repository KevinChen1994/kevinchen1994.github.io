---
{
  ...
  "summary": "RAG这个词听过很多次，我只是了解他大概是做什么的，今天看到一篇文章详细介绍了RAG的流程和基本原理，觉得很不错，就照着写了这篇文章，算是一种记录和知识扫盲吧。",
  "authors": [],
  "draft": false,
  "generated_time": "2025-02-24T12:15:23.274842"
}
---
...
![](/images/notion_9cf3abd6-64b8-4cb3-8c50-fb38c4270d3b2b9e2a4a-dc34-4151-89f3-cc7089e3a4ca.png)
...
![](/images/notion_32b8931d-fad5-4ba4-be9b-9b2430a830d5bc66182d-aaf4-4a94-b303-dbbe0cbbf29b.png)
...
![](/images/notion_e4e1497c-de13-49ad-bec7-4ef402c48b9049402376-120f-4533-96df-93f9a30a9b08.png)

- 分层索引
如果你需要从很多文档中检索信息，那对你的索引就有比较高的要求，一个有效的方法就是创建两个索引，一个由摘要组成，一个由文档块组成，并分两步进行检索。首先通过摘要筛选出相关的文档，然后在这些相关文档中检索文档块。

![](/images/notion_445e0971-eb89-42ff-b365-eaf54086e0d042708a69-54f7-4e96-ad77-77f0676ef2b6.png)
...
![](/images/notion_c06813ee-705f-4d24-91aa-8d9c51ccbe5e8d5b2c94-d1a0-4757-bf98-2c067655475a.png)

- 自动合并检索器（又称父文档检索器）
这里的想法与句子窗口检索非常类似，搜索更精准的信息片段，然后将所述上下文提供给大模型进行推理之前扩展上下文窗口。文档被分割成较小的子块，这些子块引用较大的父块。

![](/images/notion_42b4f3e2-08c3-4ac1-97fa-c3099f7443daf5f3c156-3b8f-4775-800f-000bb967a224.png)
...
![](/images/notion_b0da7bc8-af2f-4991-bb94-7e4e732d757d3cd2f9e6-d160-4f46-a55e-cb2909b28534.png)
...
![](/images/notion_99981c8a-5f9c-4847-b4e3-0f31a2cc952616cbf266-58fe-4ff4-8b88-f583ecdf91cc.png)
...
![](/images/notion_a6d5e6d1-e03f-4307-b35f-e4a7c780b22710e53590-33d3-4b5b-8e88-aee964464fdb.png)
...
![](/images/notion_94295b21-b3ae-4da9-b6a9-603b136722b3f5e2ef05-f8a2-4441-bf85-03e086113d3b.png)
